    ...
    return (
      ...
      >
        {thumbnail ? (
          ...
          <ShoppingBagIcon size={14} color={Colors.reds[500]} weight="fill" />
        )}
        <ThemedText
        ...
        {hasPrice && (
          <ThemedText style={styles.pillPrice}>
            {currency || "$"} {price}
          </ThemedText>
        )}
        <CaretLeftIcon
        ...
        {thumbnail ? (
          ...
          <View
            style={[
              ...
              { backgroundColor: Colors.reds[500] + "15" },
            ]}
          >
            <ShoppingBagIcon size={44} color={Colors.reds[500]} weight="fill" />
          </View>
        )}
        {/* Top-left badge */}
        ...
        <View style={{ flex: 1 }}>
          ...
          {hasPrice && (
            <View style={styles.cardPricePill}>
              <ThemedText style={styles.cardPriceText}>
...
const styles = StyleSheet.create({
  ...
  cardPriceText: { color: Colors.reds[500], fontSize: 14, fontWeight: "800" },
  cardViewBtn: {
  ...
  pillPrice: { fontSize: 12, fontWeight: "700", color: Colors.reds[500] },
